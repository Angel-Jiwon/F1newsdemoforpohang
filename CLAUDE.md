...
> - 게재 중단을 원하는 매체는 [GitHub Issues](https://github.com/Angel-Jiwon/F1newsdemoforpohang/issues)로 알려주시면 즉시 조치하겠습니다.
>
> 연락처는 공개 페이지에 개인 이메일을 노출하지 않으려고 저장소 이슈 창구를 쓴다. 바꾸려면 `render.py` 의 CONTACT_URL / CONTACT_LABEL.
